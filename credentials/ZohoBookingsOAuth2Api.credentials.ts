...
export class ZohoBookingsOAuth2Api implements ICredentialType {

	name = 'zohoBookingsOAuth2Api';
	extends = ['oAuth2Api'];
	displayName = 'Zoho Bookings OAuth2 API';
	documentationUrl = 'https://github.com/liamdmcgarrigle/n8n-nodes-zoho-bookings?tab=readme-ov-file#Auth'
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			name: 'scope',
			type: 'hidden',
			// default: 'zohobookings.data.CREATE,zohobookings.data.ALL',
			default: 'zohobookings.data.ALL',
		},
		{
